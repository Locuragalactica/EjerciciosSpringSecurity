...
public class PeriodistaServicio implements UserDetailsService {
    ...
    @Transactional
    public void modificarSueldo(String idPeriodista, String nombre, Integer sueldo) throws MiException {
        ...
        if (respuesta.isPresent()) {
            ...
            periodista.setPassword(new BCryptPasswordEncoder().encode(periodista.getPassword()));
